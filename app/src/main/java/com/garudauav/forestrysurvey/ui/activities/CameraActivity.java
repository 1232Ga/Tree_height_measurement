...
public class CameraActivity extends AppCompatActivity  implements SurfaceHolder.Callback, View.OnClickListener {
   ...
   // private Button zoomInButton,zoomOutButton;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        scaleGestureDetector.onTouchEvent(event);  // Pass events to the gesture detector
        return true;
    }
    private class ScaleListener extends ScaleGestureDetector.SimpleOnScaleGestureListener {
        ...
        public boolean onScale(ScaleGestureDetector detector) {
            if (camera != null) {
                ...
                // Apply zoom level to camera parameters
...
//            surfaceView.setScaleY(surfaceView.getScaleY() + 0.1f);
//        });
//
